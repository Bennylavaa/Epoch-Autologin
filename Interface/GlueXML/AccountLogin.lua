...
AccountMsg_LoadHeaders = function() end
AccountMsg_GetNumUnreadMsgs = function() return 0 end
AccountMsg_GetIndexNextUnreadMsg = function() return 0 end
AccountMsg_LoadBody = function() end
AccountMsg_GetHeaderSubject = function() return "" end
AccountMsg_GetBody = function() return "" end
end
